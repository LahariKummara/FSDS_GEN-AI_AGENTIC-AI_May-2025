...
├── Customer_Churn_Project.ipynb   # The playground: EDA, Training, and Evaluation
├── app.py                         # The application: Streamlit code for the web interface
├── final_gb_classifier.pkl        # The brain: The saved trained model
├── Telco-Customer-Churn.csv       # The raw data (ensure this file is present)
├── Output_1.png                   # App Screenshot: Input Form
├── Output_2.png                   # App Screenshot: Input Form
├── Output_3.png                   # App Screenshot: Input Form
├── Output_4.png                   # App Screenshot: Input Form
├── Output_5.png                   # App Screenshot: Prediction Result
